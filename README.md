...
|---|---|---|---|---|
| **Generative AI application for Vs profile generation** | Study of Generative models and algorithms for generation of Vs profiles, conditional on real measurements | `In Progress` | _Preprint pending_ | [Link](https://github.com/KurtSoncco/gen-ai-soil-profiles.git) |
